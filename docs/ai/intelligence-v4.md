...
| 13 | Candidate Expansion (10, generation half) — **Phase 13.1 shipped, flag-off** (`CANDIDATE_EXPANSION_ENABLED`), see [`ai/clip-ranking-engine.md`](./clip-ranking-engine.md) | Phase 1 | L | Biggest infra change — new pre-render adapter stage (13.2, not yet built); the hardcoded "Pick 1-3" prompt text is now fixed (13.1) |
