...
- **Render Quality Judge Phase C1** ("Render QA," data only) — the third phase, building on Phases
  ...
  **Shipped, flag-gated** (`RENDER_QUALITY_JUDGE_ENABLED`, default off, gates future API exposure
  ...
  Visual/Audio/Caption quality detectors, auto-reject/re-render) and Phase D (real-video benchmark/
  human evaluation) remain next, explicitly not started. See `ai/render-quality-judge.md`.
