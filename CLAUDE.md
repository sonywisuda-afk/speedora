...
- **Phase D** ("Real-video benchmark, blind human evaluation") — the fourth and final phase, closing
  ...
  prerequisites. Multi-clip expansion and the actual human evaluation session remain not started.
  See `ai/phase-d-benchmark.md`.
