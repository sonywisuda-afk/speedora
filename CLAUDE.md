...
- **Phase D** ("Real-video benchmark, blind human evaluation") — the fourth and final phase, closing
  ...
  arbitrated render over the un-arbitrated baseline for this clip. Multi-clip expansion remains not
  started; enabling `VISUAL_EMPHASIS_*_ENABLED` flags turned out to be unnecessary, not merely
  undone - Run 3 already exercised real arbitration without them. See `ai/phase-d-benchmark.md`.
