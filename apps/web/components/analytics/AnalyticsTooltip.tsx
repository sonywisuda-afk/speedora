...
// Sprint 6C.5 (Analytics UI Foundation) - the tooltip card Sprint 6B's
// TrendChart first built inline (as a private `TrendTooltip`). Theme-reactive
// via the popover/muted/foreground semantic tokens, not a hardcoded palette.
...
export function AnalyticsTooltip({ active, title, rows }: AnalyticsTooltipProps) {
  ...
  return (
    <div className="rounded-md border border-border bg-popover p-2 font-mono text-xs text-popover-foreground shadow-tooltip">
