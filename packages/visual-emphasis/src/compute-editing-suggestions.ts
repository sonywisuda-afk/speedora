...
// shape as most of Track A/B. Combines all 5 technique-specific derive
// functions and sorts the result into one chronological timeline - each
// technique's own detection logic lives in its own file (chunk-segment.ts-
// style "one function per concern" precedent), this file only composes
// them. "Generate editing suggestions" (spec Part 9) - this phase decides
// WHICH technique, WHEN, and WHY; wiring any suggestion into actual
// rendering is a later phase's job (C2-C7, see docs/ai/
